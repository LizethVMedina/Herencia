...
public class SistemaInformacion {
   ...
   //Constructor 
    ...
    public static void main(String[] args)
    {
        ...
        Persona2 sistemaInformacion=new Persona2();
        if(elegir.equalsIgnoreCase("Estudiante")){
        try 
        {
            do
            {
                //Usamos la herencia de la clase padre para acceder a los métodos de lectura de datos      
                ...
                if (opcion==1) 
                {
                    ...
                    //Leemos los datos
                    manejadorEstudiante =manejadorEstudiante.datosEstudiante();
                    //Mostramos el reporte de datos
                    manejadorEstudiante.imprimirReporte();
                }
                else
                {
                    if (opcion == 2)
